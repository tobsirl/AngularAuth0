...
import {registerEvents} from './songrecords.events';
...
var SongrecordsSchema = new mongoose.Schema({
...
registerEvents(SongrecordsSchema);
export default mongoose.model('Songrecords', SongrecordsSchema);
